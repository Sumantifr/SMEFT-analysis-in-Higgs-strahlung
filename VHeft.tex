...
\small
  \begin{tabular}{l|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|m{0.9cm}|}
    ...
    \hline
    1. Signal simulation for Run~2 & \hspace{0.25cm}\textcolor{blue}{\checkmark} &  &  &  &  &  &  &  &  &  &  & &   \\
    2. SM-EFT parameterization & \hspace{0.25cm}\textcolor{orange}{\checkmark} &  &  &  &  &  &  &  &  &  &   &  &  \\
    3. Optimization of lepton selection &  & \hspace{0.25cm}\checkmark & & & &  &  &  &  &  &  &  &   \\
    4. Optimization of \Pb tagging condition &  & \hspace{0.25cm}\textcolor{blue}{\checkmark} & & & &  &  &  &  &  &  & &   \\
    5. Optimization of \PH tagging condition &  & & \hspace{0.25cm}\textcolor{blue}{\checkmark} & & &  &  &  &  &  &   & &    \\
    6. Trigger efficiency measurement &  &  & \hspace{0.25cm}\textcolor{blue}{\checkmark} & & &  &  &  &  &  &  & &  \\
    7. Neutrino reconstruction  &  & &  & \hspace{0.25cm}\textcolor{blue}{\checkmark} & & &  &  &  &  &   & &    \\
    8. Background estimation &  &  &  & \hspace{0.25cm}\hspace{0.25cm}\textcolor{blue}{\checkmark} & & &  &  &  &  &   & &    \\
    9. Multivariate analysis &  &  &  &  & \hspace{0.25cm}\textcolor{blue}{\checkmark}  & &  &  &  &  &  & &      \\
    10. SM-EFT to SM separation &  &  & & & \hspace{0.25cm}\textcolor{orange}{\checkmark} & & &  &  &  &    & &     \\
    11. Exp. systematic uncertainties  &  &  &  &  &  & \hspace{0.25cm}\textcolor{blue}{\checkmark} &  &  &  &  &  & &       \\
    12. Modeling uncertainties &  & &  &  &  & \hspace{0.25cm}\textcolor{blue}{\checkmark} & &  &  &  &     & &    \\
    13. Sensitivity report &  & & & & & &  \hspace{0.25cm}\textcolor{blue}{\checkmark} &  &  &  &   & &     \\
    14. SM-EFT effects in background & &  & & & &  & \hspace{0.25cm}\textcolor{blue}{\checkmark} &  &  &  &   &  &    \\
    15. Publication based on Run~2 data &  & & & & &  &  & \hspace{0.25cm}\textcolor{blue}{\checkmark}  &  &  &   & &     \\
    16. Signal simulation for Run~3 &  &  & & & &  & &  \hspace{0.25cm}\checkmark  &  &  &   & &     \\
    17. Selections for Run~3 & &  & & & &  &  & & \hspace{0.25cm}\textcolor{blue}{\checkmark} &  &  & &       \\
    18. Choice of \PH tagger for Run~3 &  & & &  &  &  &  &  & \hspace{0.25cm}\checkmark  &  &   & &     \\    
    19. Background estimation for Run~3 &  & & &  &  & &  &  & & \hspace{0.25cm}\textcolor{blue}{\checkmark} &   & &     \\
    20. Systematic uncertainties for Run~3 &  & &  &  & &  &  &  &  &  & \hspace{0.25cm}\checkmark   & &     \\
    21. Combination of Run~2 and~3 results &  & & &  &  &  &  &  &  &   & & \hspace{0.25cm}\textcolor{blue}{\checkmark} &       \\
    22. Publication of final results &  & & &  &  &  &  & &  &   &  & & \hspace{0.25cm}\textcolor{blue}{\checkmark}  \\
  \end{tabular}
  \caption{
...
Total requested funding sums up to EUR 190.039.  
