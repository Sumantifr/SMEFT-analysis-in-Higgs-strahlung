...
\begin{document}
%\title{Illuminating the SMEFT with Higgs radiation}
\title{Illuminating new physics with Higgs radiation}
...
\multirow{2}{*}{Operator} &
	...
	${\cal O}_{H\widetilde{W}}$  & $\left[-0.24,+0.22\right]$  &  $\left[-0.22,+0.16\right]$  & $\left[-0.08,+0.06\right]$ \\
  \end{tabular}
\label{Tab:Limits}
\end{table}}
\end{comment}
