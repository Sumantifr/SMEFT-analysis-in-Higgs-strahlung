...
The feynman diagram with four-point interaction (Fig.~\ref{fig:Feynman_digarams}, left) involves one scalar and one vector fields, each with mass dimension one, and two fermion fields, each with mass dimension three halves.
...
using kinematic variables exhibiting energy growth and, for the first time, angular structure that is sensitive to subtle interference effects.
...
%What is the purpose of this statement? --> The answer is now given in the last sentence of the last part in this section mentioning this point
...
Also, as mentioned previously, $\PZ\PH$ production is affected by a number of operators which don't participate in $\PW\{H$ production because of the helicity structure of incoming quarks.
