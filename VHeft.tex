...
Funding is also requested for computational costs amounting to EUR yy assuming the use of 100 CPU hours per working day for four years, where each CPU hour costs about EUR xx.
