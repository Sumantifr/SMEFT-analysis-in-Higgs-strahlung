...
The DeepAK8 tagger provides probability-normalized classifier values for the top quark, \PW boson, light quark or gluon hypothesis for each AK8 jet. We use this information later for signal-to-background discrimination in the boosted topology. % FIXME Be specific --> Done
...
the SM production, dominated by the longitudinal polarization of the \PW boson, exhibits differences in $\Theta$ for nonzero ${\cal O}_{HW}$  coefficients because this operator  enhances the helicity amplitude of $\textrm{\PV}\PH$ production with transverse polarizations.%FIXME Please check the correctness. --> Done
...
\begin{figure*}[hbtp]
\begin{center}
\includegraphics[width=0.475\textwidth]{Figures/New/RECO/Plot_WH_MVA_WH_fast_resolved.png}
\includegraphics[width=0.475\textwidth]{Figures/New/RECO/ROC_plot_TT_MVA_resolved.png}
\includegraphics[width=0.475\textwidth]{Figures/New/RECO/Plot_WH_MVA_WH_fast_boosted.png}
\includegraphics[width=0.475\textwidth]{Figures/New/RECO/ROC_plot_TT_MVA_boosted.png}
\end{center}
\caption{
...
In the final work, a machine learing based algorithm developed by the PI's group to separate the effects of SM-EFT operators from that from the SM~\cite{Chatterjee:2021nms} will be used.
...
Simultaneous use of information about all three angles $\Theta$, $\theta$, $\varphi$ is expected to result in a large increase in sensitivity. 
...
Correction factors 
%need to be appropriately calculated 
