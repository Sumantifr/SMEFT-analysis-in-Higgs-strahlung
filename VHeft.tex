...
the SM production, dominated by longitudinal polarization of \PW boson, exhibits differences in $\Theta$ for nonzero ${\cal O}_{HW}$  coefficients because this operator  enhances the helicity amplitude of $\textrm{\PV}\PH$ production with transverse polarizations.%FIXME Please check the correctness. --> Done
